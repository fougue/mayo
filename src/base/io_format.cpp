...
std::string_view formatName(Format format)
{
    ...
    case Format_IFC:   return "Industry Foundation Classes";
...
bool formatProvidesBRep(Format format)
{
    static const Format brepFormats[] = {
        Format_STEP, Format_IFC, Format_IGES, Format_OCCBREP, Format_OCCXCAF, Format_DXF
    };
    return std::any_of(
